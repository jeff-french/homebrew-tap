...
- Formulas should be placed in the root directory or in a `Formula/` directory
...
- Use `url` to point to source archives, preferably with SHA256 checksums
...
- Update revision number if rebuilding without version change
